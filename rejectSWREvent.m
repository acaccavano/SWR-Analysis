...
%% data = rejectSWREvent(data, ev)
%
% Function to reject one SWR events, ensuring all data structures are properly removed, handling the optional structures if present
